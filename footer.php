<div class="footer-section" style="background: rgb(222, 101, 118)">
  <div class="w-container">
    <div class="w-row">
      <div class="w-col w-col-3">
        <a href="<?php echo site_url('/'); ?>" aria-current="page" class="logo-footer w-nav-brand w--current">
          <div class="logo-text footer-logo">Jillian.</div>
        </a>
      </div>
